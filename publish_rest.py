...
def publish(folder_name, items):
    ...
    for it in items:
        ...
        row={"id":str(uuid.uuid4()),"workspace_id":WS,"business_id":bid,"title":title,"type":t,"platform":PLATFORM_MAP.get(t,"email"),"content":it.get("body") or it.get("body_html",""),"image_url":it.get("image_url"),"tags":[],"created_at":now,"updated_at":now}
