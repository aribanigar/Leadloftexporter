...
# ===========================================================================
# DAILY RESEARCH BRIEF (2026-06-17)
# Mid-year, summer. The gifting cycle is now squarely on H2 planning and the
# year-end run-up: lock orders early, map the moments. 2026 signals: quality
# and durability as the entry ticket (fewer, better items that last), matured
# sustainability, personalisation and purpose, and high-retention everyday
# carry over throwaway swag. Onboarding kits keep driving retention. Themes
# rotate so nothing repeats the prior three days.
# ===========================================================================
SEASON = "Mid-year, H2 and year-end planning"
...
SETS = [
    dict(design='A', theme='Executive onboarding',
         ...
         subject='Day one, fully equipped',
         headline='Onboarding kits ready before day one.',
         subline='Curated sets that put your logo on every new desk.',
         items=['GG1073', 'GG1057', 'GG1079', 'GG1060', 'GG1397', 'GG1442'],
         descs=['A welcome they unbox', 'Desk-ready from day one',
                'Premium feel, your logo', 'Fewer pieces, better ones',
    ...
    dict(design='B', theme='Premium drinkware',
         ...
         subject='Built to be refilled',
         headline='Drinkware they reach for daily.',
         subline='Bottles and tumblers carried long after the campaign.',
         items=['GG1015', 'GG1033', 'GG1043', 'GG1054', 'GG1066', 'GG1072'],
         descs=['Daily carry, your brand', 'Built to last, not bin',
                'Refilled, never replaced', 'A logo they pour from',
    ...
    dict(design='A', theme='Eco and sustainable',
         ...
         subject='Better materials, kept longer',
         headline='Sustainable gifts, no greenwashing.',
         subline='Recycled and natural materials, branded to your logo.',
         items=['GG1005', 'GG1008', 'GG1013', 'GG1023', 'GG1036', 'GG1059'],
         descs=['Recycled, proudly branded', 'Natural feel, clear logo',
    ...
    dict(design='B', theme='Bags and travel',
         ...
         subject='Totes for every commute',
         headline='Bags your team takes everywhere.',
         subline='Totes and carriers printed with your brand.',
         items=['GG1114', 'GG1120', 'GG1211', 'GG1216', 'GG1381', 'GG1406'],
         descs=['Daily commute, your logo', 'Packed and branded',
                'Carried far, seen often', 'Natural fibre, clear print',
                'A logo on the move', 'Built to be carried']),
    dict(design='C', theme='Branded apparel',
         name='Branded Team Apparel', angle='Wear the brand',
         subject='Cotton that wears the brand',
         headline='Team apparel that looks the part.',
         subline='Soft cotton branded for staff and events.',
         items=['GG1007', 'GG1055', 'GG1058', 'GG1075', 'GG1076', 'GG1078'],
    ...
    dict(design='A', theme='Premium drinkware',
         name='Premium Ceramics', angle='The desk mug they choose',
         subject='The mug they choose',
         headline='Ceramic mugs that earn desk space.',
         subline='Stoneware and ceramic cups branded to your spec.',
         items=['GG1049', 'GG1082', 'GG1083', 'GG1212', 'GG1225', 'GG1264'],
         descs=['The first cup, your brand', 'Weighty, warm, branded',
                'On the desk every day', 'A mug they keep using',
                'Quiet quality, your logo', 'Branded for the morning']),
    dict(design='B', theme='Eco and sustainable',
         name='Recycled Drinkware', angle='Recycled bottles, daily carry',
         subject='Recycled steel, daily carry',
         headline='Recycled bottles built for daily use.',
         subline='Recycled steel bottles branded with your logo.',
         items=['GG1071', 'GG1085', 'GG1086', 'GG1087', 'GG1122', 'GG1123'],
    ...
    dict(design='C', theme='Notebooks and writing',
         name='Sustainable Stationery', angle='Recycled paper, clean print',
         subject='Recycled paper, clean print',
         headline='Recycled stationery, sharp branding.',
         subline='Recycled covers and clean print, made to be kept.',
         items=['GG1022', 'GG1025', 'GG1047', 'GG1048', 'GG1136', 'GG1197'],
