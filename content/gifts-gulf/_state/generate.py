...
# ===========================================================================
# DAILY RESEARCH BRIEF (2026-06-20)
# Mid-year, peak summer. H2 onboarding waves continue and the summer event and
# conference season is at its busiest. Live 2026 signals: sustainability is now
# an expectation, not a bonus (recycled steel, rPET, bamboo, recycled paper,
# organic cotton), and basic plastic is the most "overdone" giveaway. The
# winners are quality everyday-carry that lives on the desk, in the bag and at
# the gym, with subtle design-forward branding over loud logos. Stainless steel
# hydration, desk tech, glassware and natural-material pieces lead. Themes and
# SKUs rotated so nothing repeats the prior days.
# ===========================================================================
SEASON = "Peak summer, event season and H2 onboarding"
...
SETS = [
    dict(design='A', theme='Premium drinkware',
         name='Steel Bottles and Tumblers', angle='Branded daily hydration',
         subject='Steel they refuse to bin',
         headline='Steel bottles built for daily carry.',
         subline='Vacuum steel bottles and tumblers branded for the everyday.',
         items=['GG1498', 'GG1342', 'GG1329', 'GG1183', 'GG1302', 'GG1371'],
         descs=['Desk, gym and trail', 'Cold all day, branded',
                'Built to last, not bin', 'A logo they pour from',
                'Refilled, never replaced', 'Daily carry, your brand']),
    dict(design='B', theme='Tech and desk',
         name='Everyday Desk Tech', angle='Branded tools they keep',
         subject='Gadgets that earn desk space',
         headline='Desk tech that earns its place.',
         subline='Everyday gadgets branded for the workspace.',
         items=['GG1026', 'GG1274', 'GG1035', 'GG1099', 'GG1195', 'GG1110'],
    ...
    dict(design='C', theme='Eco and sustainable',
         name='Bamboo Essentials', angle='Natural materials, clearly yours',
         subject='Bamboo beats plastic, branded',
         headline='Bamboo over plastic, no greenwashing.',
         subline='Bamboo pieces branded to your logo.',
         items=['GG1461', 'GG1709', 'GG1711', 'GG1718', 'GG1641', 'GG1719'],
    ...
    dict(design='A', theme='Bags and travel',
         name='Cotton Totes and Bags', angle='Carried everywhere',
         subject='Totes worth the daily haul',
         headline='Bags your team takes everywhere.',
         subline='Cotton totes and bags printed with your brand.',
         items=['GG1586', 'GG1691', 'GG1613', 'GG1128', 'GG1443', 'GG1518'],
    ...
    dict(design='B', theme='Notebooks and writing',
         name='Paper Notebooks and Sets', angle='Where ideas land',
         subject='Pages they keep returning to',
         headline='Notebooks worth filling, branded to you.',
         subline='Clean covers and crisp print, made to be kept.',
         items=['GG1659', 'GG1638', 'GG1594', 'GG1558', 'GG1484', 'GG1105'],
    ...
    dict(design='C', theme='Premium glassware',
         name='Glassware Collection', angle='The glass they choose',
         subject='Glassware that earns its shelf',
         headline='Glassware that earns its shelf.',
         subline='Tumblers and glasses branded to your spec.',
         items=['GG1382', 'GG1469', 'GG1396', 'GG1723', 'GG1671', 'GG1468'],
         descs=['The first pour, your brand', 'Clear glass, clean logo',
                'On the shelf every day', 'A glass they keep using',
                'Quiet quality, your logo', 'Branded for the table']),
    dict(design='A', theme='Recycled and rPET',
         name='Recycled rPET Bags', angle='Recycled bags, daily carry',
         subject='Recycled bags, daily carry',
         headline='Recycled bags built for daily use.',
         subline='Recycled rPET bags branded with your logo.',
         items=['GG1486', 'GG1446', 'GG1543', 'GG1441', 'GG1299', 'GG1164'],
         descs=['Recycled and carried', 'Eco credentials, daily use',
                'Carried, not binned', 'A logo they reach for',
                'Better material, branded', 'Packed and on the move']),
    dict(design='B', theme='Recycled drinkware',
         name='Recycled Steel Drinkware', angle='Recycled bottles, daily carry',
         subject='Recycled steel, built to last',
         headline='Recycled bottles built to last.',
         subline='Recycled steel bottles branded with your logo.',
         items=['GG1174', 'GG1192', 'GG1220', 'GG1160', 'GG1152', 'GG1219'],
    ...
    dict(design='C', theme='Premium ceramics',
         name='Stoneware Mugs', angle='The cup they choose',
         subject='Mugs they reach for first',
         headline='Mugs that earn desk space.',
         subline='Stoneware and porcelain branded to your spec.',
         items=['GG1578', 'GG1666', 'GG1591', 'GG1625', 'GG1416', 'GG1584'],
