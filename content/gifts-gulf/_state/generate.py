...
# ===========================================================================
# DAILY RESEARCH BRIEF (2026-07-05)
# Deep summer, mid H2. The live 2026 read (CorporateGift, Merchery, ASI, Swag)
# holds: buyers reward daily USE over novelty, and MATERIAL is the story people
# feel in the hand. So today curates by MATERIAL: a set is one clean material
# edit so each grid reads like a catalogue page, and the material itself carries
# the premium, glass, insulated steel, stoneware, bamboo, seed paper, jute,
# recycled aluminium, recycled cotton. Branding stays present but quiet on pieces
# a person keeps in rotation at the desk and on the move. All 54 SKUs and all 9
# subjects are fresh against the last 14 days.
# ===========================================================================
SEASON = "Mid H2, material-led everyday-carry gifting"

SETS = [
    dict(design='A', theme='Glass drinkware',
         name='Glass Drinkware', angle='Glass drinkware',
         subject='Clear glass, clean pour',
         headline='Clear glass, clean pour.',
         subline='Glass bottles and tumblers for the desk, branded with your logo.',
         items=['GG1084', 'GG1437', 'GG1382', 'GG1671', 'GG1396', 'GG1468'],
         descs=['Simple glass bottle for the desk', 'Clear glass, easy to refill', 'Slim glass bottle with clean lines', 'Everyday glass for water at hand', 'Glass tumbler that suits any desk', 'Bright glass bottle made to reuse']),
    dict(design='B', theme='Insulated steel',
         name='Insulated Steel', angle='Insulated steel',
         subject='Cold holds all day',
         headline='Cold that holds all day.',
         subline='Insulated steel flasks for all-day drinks, branded with your logo.',
         items=['GG1479', 'GG1648', 'GG1662', 'GG1408', 'GG1560', 'GG1418'],
         descs=['Steel flask that keeps drinks cold', 'Slim steel bottle for the bag', 'Insulated steel, warm or cold', 'Double wall steel for all day', 'Sturdy steel bottle built to last', 'Compact steel flask for the commute']),
    dict(design='C', theme='Stoneware mugs',
         name='Stoneware Mugs', angle='Stoneware mugs',
         subject='The desk mug, upgraded',
         headline='The desk mug, upgraded.',
         subline='Stoneware mugs for the daily brew, branded with your logo.',
         items=['GG1591', 'GG1513', 'GG1264', 'GG1578', 'GG1584', 'GG1625'],
         descs=['Stoneware mug with a matte finish', 'Coloured stoneware for the morning brew', 'Rounded mug that feels good to hold', 'Simple stoneware for tea or coffee', 'Stoneware mug ready for your logo', 'Bright stoneware to lift the desk']),
    dict(design='A', theme='Bamboo desk',
         name='Bamboo Desk', angle='Bamboo desk',
         subject='Bamboo warms the desk',
         headline='Bamboo warms the desk.',
         subline='Bamboo desk pieces with a warm finish, branded with your logo.',
         items=['GG1709', 'GG1719', 'GG1711', 'GG1261', 'GG1190', 'GG1641'],
         descs=['Bamboo piece with a warm grain', 'Natural bamboo, smooth to the touch', 'Light bamboo for the desk', 'Bamboo set that calms the workspace', 'Bamboo finish, quietly premium', 'Clean bamboo lines for any desk']),
    dict(design='B', theme='Seed paper notes',
         name='Seed Paper Notes', angle='Seed paper notes',
         subject='Notes that grow after',
         headline='Notes that grow after.',
         subline='Plantable seed paper notes and books, branded with your logo.',
         items=['GG1452', 'GG1453', 'GG1457', 'GG1458', 'GG1228', 'GG1282'],
         descs=['Seed paper notes you can plant after', 'Plantable pad that grows into herbs', 'Grass paper book with a natural feel', 'Grass paper notes for quick lists', 'Recycled paper notebook, kind and simple', 'Recycled notes with a clean cover']),
    dict(design='C', theme='Jute market bags',
         name='Jute Market Bags', angle='Jute market bags',
         subject='Jute that earns its carry',
         headline='Jute that earns its carry.',
         subline='Jute and cotton bags for the daily haul, branded with your logo.',
         items=['GG1607', 'GG1609', 'GG1712', 'GG1713', 'GG1668', 'GG1518'],
         descs=['Jute bag with a rugged weave', 'Roomy jute tote for the market', 'Large jute carry for the weekly haul', 'Medium jute bag for daily runs', 'Soft cotton tote that folds flat', 'Compact cotton bag for small trips']),
    dict(design='A', theme='Sticky notes',
         name='Sticky Notes', angle='Sticky notes',
         subject='Reminders in your colour',
         headline='Reminders in your colour.',
         subline='Sticky notes and memo pads for every desk, branded with your logo.',
         items=['GG1614', 'GG1328', 'GG1564', 'GG1051', 'GG1289', 'GG1288'],
         descs=['Sticky notes that stay within reach', 'Ring bound memo pad for the desk', 'Memo kit with notes and markers', 'Handy memo pad for quick thoughts', 'Recycled sticky set in soft tones', 'Recycled memo tray to keep notes tidy']),
    dict(design='B', theme='Recycled aluminium',
         name='Recycled Aluminium', angle='Recycled aluminium',
         subject='Light metal, long refills',
         headline='Light metal, long refills.',
         subline='Recycled aluminium bottles for easy refills, branded with your logo.',
         items=['GG1142', 'GG1464', 'GG1102', 'GG1248', 'GG1119', 'GG1066'],
         descs=['Recycled aluminium bottle, light to carry', 'Slim aluminium bottle for the day', 'Recycled metal bottle built to reuse', 'Everyday aluminium for easy refills', 'Sturdy aluminium bottle for movement', 'Compact aluminium bottle for the bag']),
    dict(design='C', theme='Recycled cotton totes',
         name='Recycled Cotton Totes', angle='Recycled cotton totes',
         subject='Cotton with a history',
         headline='Cotton with a history.',
         subline='Recycled cotton totes for everyday carry, branded with your logo.',
         items=['GG1477', 'GG1514', 'GG1393', 'GG1118', 'GG1324', 'GG1700'],
         descs=['Recycled cotton tote, soft and strong', 'Organic cotton bag for the daily carry', 'Organic cotton tote in calm tones', 'Coloured organic cotton shopper', 'Cotton bag that folds away small', 'Cotton tote ready for your logo']),
]
