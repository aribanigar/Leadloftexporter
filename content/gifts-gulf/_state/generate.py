...
SETS = [
    dict(design='A', theme='Everyday notebooks',
         name='Everyday Notebooks', angle='Everyday notebooks',
         subject='Notes that pull their weight',
         headline='Notes that pull their weight.',
         subline='Recycled paper notebooks for every desk and meeting, branded with your logo.',
         items=['GG1047', 'GG1048', 'GG1223', 'GG1239', 'GG1493', 'GG1652'],
         descs=['Recycled paper, smooth to write on', 'A larger pad for long meetings', 'Sturdy cover, keeps its shape', 'Sticky notes always within reach', 'Made from recycled cartons', 'Keeps loose papers in order']),
    dict(design='B', theme='Recycled hydration',
         name='Recycled Hydration', angle='Recycled hydration',
         subject='Refilled, never thrown away',
         headline='Refilled, not thrown away.',
         subline='Recycled bottles for all-day hydration, branded with your logo.',
         items=['GG1202', 'GG1208', 'GG1215', 'GG1243', 'GG1327', 'GG1710'],
         descs=['Light bottle made for movement', 'Grippy body, easy daily refill', 'Recycled steel, built to last', 'Single wall, slim and simple', 'A bigger pour for busy days', 'Clear glass tumbler for the desk']),
    dict(design='C', theme='Totes and shoppers',
         name='Totes And Shoppers', angle='Totes and shoppers',
         subject='Totes for the daily haul',
         headline='Totes for the daily haul.',
         subline='Recycled fabric totes for the daily carry, branded with your logo.',
         items=['GG1024', 'GG1169', 'GG1333', 'GG1415', 'GG1605', 'GG1606'],
         descs=['Roomy tote in bright recycled fabric', 'Folds small, opens wide', 'Everyday shopper with a soft feel', 'Structured tote that holds its shape', 'Shoulder bag for the daily load', 'Simple carry all in recycled fabric']),
    dict(design='A', theme='Desk tech',
         name='Desk Tech', angle='Desk tech',
         subject='The desk, powered up',
         headline='The desk, powered up.',
         subline='Charging and desk pieces that keep your brand in view, branded with your logo.',
         items=['GG1159', 'GG1626', 'GG1303', 'GG1362', 'GG1663', 'GG1593'],
         descs=['Slim recycled power bank for the bag', 'Power bank and notebook in one', 'Recycled notebook with a built in cable', 'Compact charger for phone and more', 'Bamboo stand with wireless charging', 'Folding desk light with a warm glow']),
    dict(design='B', theme='Branded apparel',
         name='Branded Apparel', angle='Branded cotton wear',
         subject='Wear the brand well',
         headline='Wear the brand well.',
         subline='Cotton wear for teams and events, branded with your logo.',
         items=['GG1003', 'GG1002', 'GG1001', 'GG1027', 'GG1232', 'GG1004'],
         descs=['Soft brushed hoodie for the whole team', 'Classic cotton polo, clean and smart', 'Organic cotton tee that wears in fast', 'Cotton cap that goes with everything', 'Lightweight cap in recycled fabric', 'Heavy cotton twill baseball cap']),
    dict(design='C', theme='Cork and bamboo',
         name='Cork And Bamboo', angle='Cork and bamboo',
         subject='Nature, right on the desk',
         headline='Nature, right on the desk.',
         subline='Cork and bamboo pieces for a calmer desk, branded with your logo.',
         items=['GG1236', 'GG1699', 'GG1698', 'GG1492', 'GG1454', 'GG1276'],
         descs=['Notebook with a warm cork cover', 'Cork bound notes for the desk', 'Slim cork folder for papers', 'Bamboo desk piece, clean and quiet', 'Bamboo backed notes with a natural feel', 'Cork gift set with a premium finish']),
    dict(design='A', theme='Organic cotton bags',
         name='Organic Cotton Bags', angle='Organic cotton bags',
         subject='Cotton that carries more',
         headline='Cotton that carries more.',
         subline='Organic and recycled cotton bags for every day, branded with your logo.',
         items=['GG1117', 'GG1234', 'GG1392', 'GG1442', 'GG1460', 'GG1472'],
         descs=['Organic cotton shopper, sturdy and reusable', 'Coloured recycled cotton tote', 'Organic cotton bag in soft tones', 'Small cotton pouch for daily bits', 'Recycled cotton bag for the carry', 'Compact organic cotton drawstring']),
    dict(design='B', theme='Gift sets',
         name='Gift Sets', angle='Ready to gift',
         subject='Boxed and ready to give',
         headline='Boxed, wrapped, ready to give.',
         subline='Ready to gift sets for the moments that matter, branded with your logo.',
         items=['GG1145', 'GG1502', 'GG1693', 'GG1395', 'GG1034', 'GG1511'],
         descs=['Recycled steel drink set, ready to gift', 'Writing set boxed and tidy', 'Wood desk set for the planner', 'Cork set with a natural finish', 'Insulated set that travels well', 'Recycled carton set, clean and simple']),
    dict(design='C', theme='Recycled carry',
         name='Recycled Carry', angle='Recycled carry',
         subject='Carry it, keep it, reuse it',
         headline='Carry it, keep it, reuse it.',
         subline='Recycled backpacks and totes for everyday carry, branded with your logo.',
         items=['GG1124', 'GG1059', 'GG1060', 'GG1708', 'GG1688', 'GG1383'],
         descs=['Structured backpack with a city look', 'Recycled backpack for daily commutes', 'Roomy recycled pack for longer days', 'Light recycled tote for quick trips', 'Soft carry bag that folds away', 'Natural hemp tote, quietly premium']),
]
