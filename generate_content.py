#!/usr/bin/env python3
"""Generate Hudace content batch - 2026-06-29 - Industries: Aerospace and Defense, Automotive.
...
EMAILS = [
    {
        ...
        "label": "SEO / AEO / GEO / SRX - AEROSPACE AND DEFENSE",
        "headline": "Be the Capability Found First When a Requirement Is Shaped",
        "sub": "Aerospace and defense buyers research suppliers long before a tender is written, now across search results and AI answers at once. Hudace optimizes for both so your capability is visible at the moment a requirement is being defined.",
        "bg_query": "aircraft jet aerospace dark sky cinematic",
        "body_query": "engineering blueprint technical data screen dark",
        ...
        "scope": "Aerospace and defense procurement is technical, long, and quietly research-led. Programs are scoped through specification searches and capability comparisons that now play out across search engines and AI answers together. Optimizing capability and certification pages for both means your organization is the one cited when an engineer or buyer investigates who can meet a requirement, rather than a competitor whose pages were structured to be found.",
    ...
    },
    {
        "key": "aerospace-erp",
        "industry": "Aerospace and Defense",
        "label": "ERP BUILDING - AEROSPACE AND DEFENSE",
        "headline": "Custom Software That Runs Programs, Compliance, and Supply as One System",
        "sub": "When program data, quality records, and supplier status live in separate tools, traceability and rework grow between them. Hudace builds custom business software on the Xenon AI platform so your operation runs as one auditable system.",
        "bg_query": "aerospace factory manufacturing dark industrial",
        "body_query": "software dashboard engineering data dark",
        "card_head": "Custom ERP and SaaS",
        "card_bullets": ["Discovery and module blueprint", "Programs, quality, supply modules", "Role-based access and dashboards", "Web and mobile access"],
        "deliverables": [
        ...
        "scope": "Aerospace and defense work carries strict requirements for traceability, access control, and accuracy across programs, quality, and a deep supplier base. Custom software built to your workflow, with role-based access and automation across the steps teams repeat daily, removes the manual handoffs where errors and audit gaps appear and keeps every record tied to the part, program, and approval it belongs to.",
        "proof": "We have built operational software for technical and manufacturing businesses, with reported reductions in administrative overhead and cleaner records once manual steps moved into controlled, automated workflows.",
        "future": "The platform grows with the program. New modules and integrations add without replacing the systems that already work.",
        "hooks": [
            ("One system removes the seams", "When program, quality, and supplier data share controlled records, the gaps where errors and audit issues hide simply close."),
            ("Automation returns hours, and accuracy", "Workflows handle the repeated steps with a consistent trail, so engineers and staff spend time on judgement, not reconciliation."),
    ...
    {
        "key": "aerospace-aistudio",
        "industry": "Aerospace and Defense",
        "label": "AI WORK STUDIO - AEROSPACE AND DEFENSE",
        "headline": "A Cinematic Film That Conveys Engineering Authority, Without a Film Crew",
        "sub": "Aerospace and defense brands are judged on precision and command of complexity, and that is communicated best on screen. Hudace AI Work Studio produces a cinematic film of your organization in seven working days, with no crew on site.",
        "bg_query": "fighter jet aircraft cinematic dark dramatic",
        "body_query": "film camera production cinematic dark",
        "card_head": "AI Work Studio for Aerospace",
        ...
        "scope": "A partner evaluating an aerospace or defense supplier responds to assurance, precision, and command of complex work that they can see. A cinematic film communicates the organization's standing and engineering approach in sixty seconds, in a format that travels across capability decks, exhibitions, and partner conversations.",
        "proof": "We have produced cinematic films for technical and industrial businesses, delivering finished work in days rather than the weeks a traditional shoot requires.",
        "future": "One film fuels months of presence. The social cuts and stills feed the content calendar and capability decks long after delivery.",
        "hooks": [
            ("Precision is best shown, not described", "A cinematic treatment conveys engineering standing and rigor in seconds that a specification sheet cannot."),
            ("Seven days keeps pace with the program", "AI production removes the crew, the secure-site access, and the wait, so the film ships while the opportunity is live."),
            ("One shoot, many assets", "A film, three cuts, and ten stills give every channel something to run from a single brief."),
        ],
        "closing": "Describe your organization and we will return a concept and a delivery date.",
    },
    {
        "key": "automotive-social",
        "industry": "Automotive",
        "label": "SOCIAL MEDIA - AUTOMOTIVE",
        "headline": "Social Media That Keeps Buyers Engaged From Showroom to Service",
        "sub": "Automotive buyers research for weeks and judge a brand by how present and responsive it feels online. Hudace runs a fully managed social function so your dealership or marque stays visible across the long path to purchase and beyond.",
        "bg_query": "luxury car night city lights dark cinematic",
        "body_query": "smartphone social media car content dark",
        "card_head": "Social Media for Automotive",
        ...
        "scope": "Automotive purchases are considered over weeks, and the brand a buyer keeps seeing is the one they walk in to. A structured calendar built around models, offers, and the ownership experience turns routine activity into the steady visibility that fills the showroom, while managed comments and messages handle the questions that decide a test drive.",
        "proof": "We have run managed social programs that replaced irregular posting with a steady calendar, keeping the brand present and responsive through every model and campaign cycle.",
        "future": "Social builds the first impression and the daily relationship. It layers into SEO, website, and AI cinematic video so attention moves into a measurable pipeline of bookings.",
        "hooks": [
            ("Presence wins the long decision", "Six videos and twelve posts a month keep the brand in front of a buyer through the weeks they spend choosing."),
            ("Response turns interest into a test drive", "Managed community handling answers comments and messages quickly, so a question becomes a booking instead of a missed lead."),
        ...
        "closing": "Tell us your next model or offer and we will return a content calendar built for it.",
    },
    {
        "key": "automotive-website",
        "industry": "Automotive",
        "label": "WEBSITE DESIGN - AUTOMOTIVE",
        "headline": "A Website That Turns Automotive Visitors Into Bookings",
        "sub": "Most automotive sites list models. Few are built to convert the visitor into a test drive or service booking on a phone. Hudace delivers a fast, mobile-first site engineered to turn research traffic into enquiries.",
        "bg_query": "modern car showroom dark blue lighting",
        "body_query": "laptop website design automotive office",
        "card_head": "Website Design for Automotive",
        ...
        "scope": "Automotive research happens on a phone, between other tasks, and the booking is won or lost on speed and clarity. A mobile-first site with clear model pages, fast load times, and booking and WhatsApp paths removes friction at the decision, so a ready buyer reserves a test drive or service slot on the same visit rather than leaving to compare elsewhere.",
        ...
        "future": "The site becomes the hub. SEO drives qualified traffic to it and social keeps it warm between model launches.",
        "hooks": [
            ("Speed protects the visit", "A fast, mobile-first build keeps a buyer on the page where a slow one loses them before the booking."),
            ("Structure earns the ranking", "An SEO-ready architecture lets search engines place you for the models and services buyers actually search."),
            ("Forms turn traffic into pipeline", "Booking, lead, and WhatsApp paths capture intent at the moment it peaks, not days later."),
        ],
        "closing": "Send us your current site and we will return a build plan and a launch timeline.",
    },
    {
        "key": "schoolos",
        "imgbase": "schoolos-jun29",
        "industry": None,
...
SERVICE_NAME = {
    "aerospace-seo": "SEO / AEO / GEO / SRX",
    "aerospace-erp": "ERP Building",
    "aerospace-aistudio": "AI Work Studio",
    "automotive-social": "Social Media",
    "automotive-website": "Website Design",
