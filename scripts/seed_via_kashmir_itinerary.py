#!/usr/bin/env python3
"""
seed_via_kashmir_itinerary.py - seed ONE day of ViaKashmir Itinerary content into the
Content Hub DB. Independent of the main ViaKashmir engine. Talks to Neon over its HTTPS
SQL endpoint (port 443), not the Postgres wire protocol, so it works from routine runners.
