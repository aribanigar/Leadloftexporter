...
def _apply_research(cfg, market, date):
    """If the daily research wrote destinations.json, override the hero/feature photo so
    the featured locations stay fresh. Shape: {"<market>": {"photo": "...", "feat": "..."}}."""
...
def write_set(date, market, preview):
    ...
    (out / "email.html").write_text(email_html(cfg, preview))
